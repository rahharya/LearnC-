...
class HideRectangle:public Shape
{
    ...
    //Constructor
        ...
        //2. Parameter Constructor
            HideRectangle(int length=1, int Width=1);
    ...
    //Property Function
        ...
        // Get -> Accesor
            int getLength() const; // cannot define member of a class when function declared as const
            int getWidth() const;
    //Facilitator
        int area();
        int perimeter();
        void inLineFunction() const{cout<<"InLine called"<<endl;}
...
int HideRectangle::getLength() const{
    // cannot define member of a class when function declared as const
    // length=20; //<< ERROR
    return length;           
} 
int HideRectangle::getWidth() const{
    return width;
}
...
void HideRectangle::nonInLineFunction() const{
